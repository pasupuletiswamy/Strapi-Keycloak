...
module.exports = async () => {
  ...
  const grantConfig = {
    ...
    keycloak: {
      ...
      secret: 'xyz',
      oauth: 2,
      authorize_url: 'http://localhost:8080/auth/realms/myproject/protocol/openid-connect/auth', // authorization_endpoint
      access_url: 'http://localhost:8080/auth/realms/myproject/protocol/openid-connect/token', // token_endpoint
      callback: '',
      scope: ['email']
  },
  };
